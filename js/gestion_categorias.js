if (!window.isGestionCategoriasInitialized) {
    ...
    document.addEventListener("DOMContentLoaded", async () => {
        ...
        async function loadCategories() {
            try {
                const response = await fetch("https://webcotito-production.up.railway.app/categorias/listar", {
                    headers: {
        ...
        async function deleteCategory(categoryName) {
            try {
                const response = await fetch(`https://webcotito-production.up.railway.app/categorias/eliminar/${encodeURIComponent(categoryName)}`, {
                    method: "DELETE",
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
        ...
        async function addCategory(categoryName) {
            try {
                const response = await fetch("https://webcotito-production.up.railway.app/categorias/agregar", {
                    method: "POST",
                    headers: {
